...
/**
 * 
 * Servicio que servirá para las configuraciones globales de la
 * aplicación web, esto incluye algunas consultas a la API REST que
...
export class GlobalService {
  ...
  public listStateUsers(): Observable<Response> {
    let url: string = `${this.url}/dicc-state-users/list`;
