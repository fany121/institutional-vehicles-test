...
export class SessionService {
  ...
  public setCurrentUser(token: Token | undefined): void {
    ...
    if (token) {
      ...
      if (decoded) {
        ...
        this._cookieService.set('tickets-user', JSON.stringify(token));
      }
    } else {
      this._cookieService.delete('tickets-user');
    }
  ...
  public getTokenCookie(): string | null {
    return this._cookieService.check('tickets-user') ? this._cookieService.get('tickets-user') : null;
  }
